...
from src.core.channel_monitor import ChannelMonitoringOrchestrator
...
class MessageCaptureProof:
                ...
                messages = await self.telethon_client.get_recent_messages(channel_id, limit=3)
                     ...
                     for i, msg in enumerate(messages, 1):
                         ...
                         if hasattr(msg, 'date'):
                             ...
                             msg_content = msg.text or msg.message or '[Media/Non-text content]'
                             msg_id = msg.id
    ...
    async def _monitor_for_new_messages(self):
        ...
        logger.info("\n⏱️  Step 4: Monitoring for New Messages (30 seconds)")
        logger.info("-" * 40)
        ...
        for i in range(30):
            ...
            if (i + 1) % 10 == 0:
                logger.info(f"⏰ {30 - i - 1} seconds remaining... ({new_messages} new messages captured)")
